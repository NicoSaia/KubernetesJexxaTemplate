package io.jexxa.kubernetesjexxatemplate.applicationservice;

import io.jexxa.addend.applicationcore.DomainService;
import io.jexxa.kubernetesjexxatemplate.KubernetesJexxaTemplate;
import io.jexxa.kubernetesjexxatemplate.domain.book.BookNotInStockException;
import io.jexxa.kubernetesjexxatemplate.domain.book.BookRepository;
import io.jexxa.kubernetesjexxatemplate.domain.book.BookSoldOut;
import io.jexxa.kubernetesjexxatemplate.domain.book.ISBN13;
import io.jexxa.kubernetesjexxatemplate.domainservice.DomainEventSender;
...
import static io.jexxa.kubernetesjexxatemplate.domain.book.BookSoldOut.bookSoldOut;
import static io.jexxa.kubernetesjexxatemplate.domain.book.ISBN13.createISBN;
...
class BookStoreServiceTest
{
    ...
    void initTest()
    {
        ...
        JexxaTest jexxaTest = getJexxaTest(KubernetesJexxaTemplate.class);
