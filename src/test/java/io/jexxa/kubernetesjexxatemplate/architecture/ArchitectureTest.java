package io.jexxa.kubernetesjexxatemplate.architecture;
...
class ArchitectureTest {
    ...
    {
        portsAndAdapters(KubernetesJexxaTemplate.class)
    ...
    {
        patternLanguage(KubernetesJexxaTemplate.class).validate();
    }

    @Test
    void validateAggregateRules()
    {
        aggregateRules(KubernetesJexxaTemplate.class).validate();
    }
}