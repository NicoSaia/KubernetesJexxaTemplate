package io.jexxa.kubernetesjexxatemplate.integration;
...
class KubernetesJexxaTemplateIT
{
    ...
    {
        jexxaIntegrationTest = new JexxaIntegrationTest(KubernetesJexxaTemplate.class);
    ...
    void testStartupApplication()
    {
        ...
        //Assert
        assertEquals(KubernetesJexxaTemplate.class.getSimpleName(), result);
    }
